...
describe('checkOrderValidity', () => {
  const warehouses: Warehouse[] = [
    { id: 1, name: 'Los Angeles', cost_per_kg_km: 0.01, stock: 30, latitude: 33.9425, longitude: -118.408056, created_at: new Date(), updated_at: new Date() },
    { id: 2, name: 'New York', cost_per_kg_km: 0.01, stock: 50, latitude: 40.639722, longitude: -73.778889, created_at: new Date(), updated_at: new Date() },
  ];
  ...
  test('should not fulfill from warehouses with zero stock', () => {
    ...
    const warehouses = [
      { id: 1, name: 'Los Angeles', cost_per_kg_km: 0.01, stock: 0, latitude: 33.9425, longitude: -118.408056, created_at: new Date(), updated_at: new Date() },
      { id: 2, name: 'New York', cost_per_kg_km: 0.01, stock: 0, latitude: 40.639722, longitude: -73.778889, created_at: new Date(), updated_at: new Date() },
    ];
